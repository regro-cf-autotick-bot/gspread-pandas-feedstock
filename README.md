...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/gspread-pandas-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gspread-pandas-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add gspread-pandas
# for installing globally
pixi global install gspread-pandas
```
...
It is possible to list all of the versions of `gspread-pandas` available on your platform:
...
```
pixi search gspread-pandas --channel conda-forge
```
